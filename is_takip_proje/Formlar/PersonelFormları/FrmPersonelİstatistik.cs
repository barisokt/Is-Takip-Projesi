...
namespace is_takip_proje.Formlar
{
    public partial class FrmPersonelİstatistik : Form
    {
        ...
        private void FrmPersonelİstatistik_Load(object sender, EventArgs e)
        {
            ...
            LblTamamlananİş.Text = db.TblGorevler.Count(x => x.Durum== false).ToString();
        ...
        private void LblSonGörev_Click(object sender, EventArgs e)
        {

        }

        private void LblŞehir_Click(object sender, EventArgs e)
        {
